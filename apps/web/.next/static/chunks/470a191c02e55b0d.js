(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,91417,14677,a=>{"use strict";let e,n="undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),o=new Uint8Array(16),i=[];for(let a=0;a<256;++a)i.push((a+256).toString(16).slice(1));let t=function(a,t,r){if(n&&!t&&!a)return n();var c=a,l=r;let s=(c=c||{}).random??c.rng?.()??function(){if(!e){if("undefined"==typeof crypto||!crypto.getRandomValues)throw Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");e=crypto.getRandomValues.bind(crypto)}return e(o)}();if(s.length<16)throw Error("Random bytes length must be >= 16");if(s[6]=15&s[6]|64,s[8]=63&s[8]|128,t){if((l=l||0)<0||l+16>t.length)throw RangeError(`UUID byte range ${l}:${l+15} is out of buffer bounds`);for(let a=0;a<16;++a)t[l+a]=s[a];return t}return function(a,e=0){return(i[a[e+0]]+i[a[e+1]]+i[a[e+2]]+i[a[e+3]]+"-"+i[a[e+4]]+i[a[e+5]]+"-"+i[a[e+6]]+i[a[e+7]]+"-"+i[a[e+8]]+i[a[e+9]]+"-"+i[a[e+10]]+i[a[e+11]]+i[a[e+12]]+i[a[e+13]]+i[a[e+14]]+i[a[e+15]]).toLowerCase()}(s)};a.s(["v4",0,t],14677);let r="appteczka_medicines";function c(){try{let a=localStorage.getItem(r);if(!a)return[];let e=JSON.parse(a);return Array.isArray(e)?e:[]}catch{return console.error("Błąd odczytu danych z localStorage"),[]}}function l(a){try{localStorage.setItem(r,JSON.stringify(a))}catch{console.error("Błąd zapisu danych do localStorage")}}function s(a){let e=c(),n=[];for(let o of a){if(!o.nazwa)continue;let a=e.find(a=>a.nazwa?.toLowerCase().trim()===o.nazwa?.toLowerCase().trim());a&&n.push({nazwa:o.nazwa,existingId:a.id})}return n}function y(a,e){let n=c(),o=[];for(let i of a.leki){if(!i.nazwa){let a={id:t(),nazwa:i.nazwa,opis:i.opis,wskazania:i.wskazania,tagi:i.tagi,labels:i.labels,notatka:i.notatka,dataDodania:new Date().toISOString()};o.push(a);continue}let a=e.get(i.nazwa)||"add",r=n.findIndex(a=>a.nazwa?.toLowerCase().trim()===i.nazwa?.toLowerCase().trim());if(-1!==r&&"replace"===a)n[r]={...n[r],opis:i.opis,wskazania:i.wskazania,tagi:i.tagi,labels:i.labels,notatka:i.notatka};else{if("skip"===a)continue;let e={id:t(),nazwa:i.nazwa,opis:i.opis,wskazania:i.wskazania,tagi:i.tagi,labels:i.labels,notatka:i.notatka,dataDodania:new Date().toISOString()};o.push(e)}}return l([...n,...o]),o}function z(a,e){let n=c(),o=[];for(let i of a.leki){if(!i.nazwa){let a={...i,id:t(),dataDodania:i.dataDodania||new Date().toISOString()};o.push(a);continue}let a=e.get(i.nazwa)||"add",r=n.findIndex(a=>a.nazwa?.toLowerCase().trim()===i.nazwa?.toLowerCase().trim());if(-1!==r&&"replace"===a)n[r]={...i,id:n[r].id};else{if("skip"===a)continue;let e={...i,id:t(),dataDodania:i.dataDodania||new Date().toISOString()};o.push(e)}}return l([...n,...o]),o}function w(a){let e=c(),n=e.filter(e=>e.id!==a);return n.length!==e.length&&(l(n),!0)}function d(a,e){let n=c(),o=n.findIndex(e=>e.id===a);return -1===o?null:(n[o]={...n[o],...e},l(n),n[o])}function k(){localStorage.removeItem(r)}function u(){return JSON.stringify({leki:c()},null,2)}function p(a){if(!a||"object"!=typeof a||!Array.isArray(a.leki)||0===a.leki.length)return!1;let e=a.leki[0];return"string"==typeof e.id&&"string"==typeof e.dataDodania}a.s(["clearMedicines",()=>k,"deleteMedicine",()=>w,"exportMedicines",()=>u,"findDuplicates",()=>s,"getMedicines",()=>c,"importBackup",()=>z,"importMedicinesWithDuplicateHandling",()=>y,"isBackupFormat",()=>p,"updateMedicine",()=>d],91417)},75276,40559,a=>{"use strict";function e(){return`# Prompt – Rozpoznawanie lek\xf3w ze zdjęcia (Import JSON)
